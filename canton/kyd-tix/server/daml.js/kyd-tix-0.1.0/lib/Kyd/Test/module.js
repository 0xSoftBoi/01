...
exports.Cast = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({operator: damlTypes.Party.decoder, venue: damlTypes.Party.decoder, artist: damlTypes.Party.decoder, alice: damlTypes.Party.decoder, bob: damlTypes.Party.decoder, lender: damlTypes.Party.decoder, lender2: damlTypes.Party.decoder, public: damlTypes.Party.decoder, }); }),
