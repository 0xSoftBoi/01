...
exports.Allocation = damlTypes.assembleInterface(
  '0fda37a3ae5ff52c2032aac79884f38e64179923382a91769b3cbb99371d7900:Splice.Api.Token.AllocationV1:Allocation',
...
exports.Reference = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({id: damlTypes.Text.decoder, cid: damlTypes.Optional(damlTypes.ContractId(Splice_Api_Token_MetadataV1.AnyContract)).decoder, }); }),
  encode: function (__typed__) {
  return {
