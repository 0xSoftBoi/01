...
exports.TransferFactory = damlTypes.assembleInterface(
  '0fda37a3ae5ff52c2032aac79884f38e64179923382a91769b3cbb99371d7900:Splice.Api.Token.TransferInstructionV1:TransferFactory',
...
exports.TransferInstruction = damlTypes.assembleInterface(
  '0fda37a3ae5ff52c2032aac79884f38e64179923382a91769b3cbb99371d7900:Splice.Api.Token.TransferInstructionV1:TransferInstruction',
...
exports.TransferInstructionView = {
  decoder: damlTypes.lazyMemo(function () { return jtv.object({originalInstructionCid: damlTypes.Optional(damlTypes.ContractId(exports.TransferInstruction)).decoder, transfer: exports.Transfer.decoder, status: exports.TransferInstructionStatus.decoder, meta: Splice_Api_Token_MetadataV1.Metadata.decoder, }); }),
  encode: function (__typed__) {
  return {
