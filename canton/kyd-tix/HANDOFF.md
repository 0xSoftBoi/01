...
```
make test     # Daml: 2 packages, 33 scenarios (functional/adversarial/CIP-56)
...
| Layer | Verification |
| --- | --- |
| Daml model (`daml/`) | 33 scenarios in CI: functional + adversarial attack suites + CIP-56 interface suites + demo seed. Zero warnings (divulgence-free). |
